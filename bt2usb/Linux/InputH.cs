...
namespace bt2usb.Linux
{
    public static class InputH
    {
        ...
        public static uint EVIOCGNAME(uint len) => _IOC(_IOC_READ, 'E', 0x06, len); /* get device name */
        public static uint EVIOCGPHYS(uint len) => _IOC(_IOC_READ, 'E', 0x07, len); /* get physical location */
        public static uint EVIOCGUNIQ(uint len) => _IOC(_IOC_READ, 'E', 0x08, len); /* get unique identifier */
        public static uint EVIOCGPROP(uint len) => _IOC(_IOC_READ, 'E', 0x09, len); /* get device properties */
         ...
         */
        public static uint EVIOCGMTSLOTS(uint len) => _IOC(_IOC_READ, 'E', 0x0a, len);

        public static uint EVIOCGKEY(uint len) => _IOC(_IOC_READ, 'E', 0x18, len) /* get global key state */;
        public static uint EVIOCGLED(uint len) => _IOC(_IOC_READ, 'E', 0x19, len) /* get all LEDs */;
        public static uint EVIOCGSND(uint len) => _IOC(_IOC_READ, 'E', 0x1a, len) /* get all sounds status */;
        public static uint EVIOCGSW(uint len) => _IOC(_IOC_READ, 'E', 0x1b, len) /* get all switch states */;

        public static uint EVIOCGBIT(uint ev, uint len) => _IOC(_IOC_READ, 'E', 0x20 + ev, len) /* get event bits */;
        public static uint EVIOCGABS(uint abs) => _IOR<input_absinfo>('E', 0x40 + abs) /* get abs value/limits */;
        public static uint EVIOCSABS(uint abs) => _IOW<input_absinfo>('E', 0xc0 + abs) /* set abs value/limits */;

        public static uint EVIOCSFF() =>
            _IOW<ff_effect>('E', 0x80) /* send a force effect to a force feedback device */;

        public static uint EVIOCRMFF() => _IOW<int>('E', 0x81) /* Erase a force effect */;

        public static uint EVIOCGEFFECTS() =>
            _IOR<int>('E', 0x84) /* Report number of effects playable at the same time */;

        public static uint EVIOCGRAB() => _IOW<int>('E', 0x90) /* Grab/Release device */;
        public static uint EVIOCREVOKE() => _IOW<int>('E', 0x91) /* Revoke device access */;
         ...
         */
        public static uint EVIOCGMASK() => _IOR<input_mask>('E', 0x92);
         ...
         */
        public static uint EVIOCSMASK() => _IOW<input_mask>('E', 0x93) /* Set event-masks */;

        public static uint EVIOCSCLOCKID() => _IOW<int>('E', 0xa0) /* Set clockid to be used for timestamps */;

...
namespace bt2usb.Linux.Udev
{
    ...
    public sealed class Enumerator : IEnumerable<Device>, IDisposable
    {
        ...
        private Enumerator(IntPtr handle)
        {
            this.handle = handle;
        }
        ...
        /// </summary>
        public Context Context => Context.GetInstance(udev_enumerate_get_udev(Handle));
        ...
        private IEnumerable<Device> List
        {
            get
            {
                ...
                if (ptr == IntPtr.Zero)
                {
                    ...
                    if (err == Errno.ENODATA) yield break;
        ...
        private static extern IntPtr udev_enumerate_get_udev(IntPtr udev_enumerate);

        [DllImport(UdevLibraryName, SetLastError = true)]
        private static extern IntPtr udev_enumerate_get_list_entry(IntPtr udev_enumerate);

        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        private static extern int udev_enumerate_add_match_subsystem(IntPtr udev_enumerate, string subsystem);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        private static extern int udev_enumerate_add_nomatch_subsystem(IntPtr udev_enumerate, string subsystem);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        private static extern int udev_enumerate_add_match_sysattr(IntPtr udev_enumerate, string sysattr, string value);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        private static extern int udev_enumerate_add_nomatch_sysattr(IntPtr udev_enumerate, string sysattr,
            string value);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        private static extern int udev_enumerate_add_match_property(IntPtr udev_enumerate, string property,
            string value);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        private static extern int udev_enumerate_add_match_tag(IntPtr udev_enumerate, string tag);
        ...
        [DllImport(UdevLibraryName)]
        private static extern int udev_enumerate_add_match_parent(IntPtr udev_enumerate, IntPtr parent);
        ...
        [DllImport(UdevLibraryName)]
        private static extern int udev_enumerate_add_match_is_initialized(IntPtr udev_enumerate);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        private static extern int udev_enumerate_add_match_sysname(IntPtr udev_enumerate, string sysname);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        private static extern int udev_enumerate_add_syspath(IntPtr udev_enumerate, string syspath);
        ...
        [DllImport(UdevLibraryName)]
        private static extern int udev_enumerate_scan_devices(IntPtr udev_enumerate);
        ...
        [DllImport(UdevLibraryName)]
        private static extern int udev_enumerate_scan_subsystems(IntPtr udev_enumerate);
        ...
        private static IntPtr New(Context udev)
        {
            if (udev == null) throw new ArgumentNullException(nameof(udev));
            var handle = udev_enumerate_new(udev.Handle);
            if (handle == null) throw new UnixIOException(Marshal.GetLastWin32Error());
        ...
        [DllImport(UdevLibraryName)]
        private static extern IntPtr udev_enumerate_unref(IntPtr udev_enumerate);
